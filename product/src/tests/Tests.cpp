...
// TEST(T, a)
// {
//   //Position pos = Position("4r2k/1p3rbp/2p1N1p1/p3n3/P2NB1n1/1P6/4R1Pq/B1Q2RK1 w - - 5 33");
//   //Position pos = Position("8/8/8/8/8/8/7q/6K1 w - - 0 1");
//   Position pos = Position("8/8/8/8/8/5q2/4K3/8 w - - 0 1");
//   //Position pos = Position("8/8/8/8/8/8/7q/8 w - - 0 1");
//   // Position pos = Position("8/8/8/8/8/8/6q1/8 w - - 0 1"); // queen moved
//   // //Position pos = Position("8/8/8/8/8/8/6q1/6K1 w - - 0 1"); // queen moved with king
//   // Position pos = Position("8/8/8/8/8/8/6q1/6R1 w - - 0 1"); // rook
//   // auto attacks = pos.generate_piece_attacks(Piece::QUEEN, Utils::find_ls1b_index(pos.get_queens()));
...
//   //Utils::print_bb(attacks);
//   //std::cout << (bool)pos.in_check() << std::endl;

//   // auto moves = pos.generate_all_moves(false);
//   // for(Move m : moves)
//   // {
//   //   std::cout << Utils::move_to_board_notation(m) << std::endl;
//   // }
//   // auto attacks = pos.generate_piece_attacks(Piece::QUEEN, 15);
//   // Utils::print_bb(attacks);
//   std::cout << (pos.in_check() ? "true" : "false") << std::endl;
//   // seems to get attacks wrong if wrong turn.
// }
